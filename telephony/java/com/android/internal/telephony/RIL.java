...
*/
        switch(request) {
            ...
            case RIL_REQUEST_CDMA_GET_DATAPROFILE: return "RIL_REQUEST_CDMA_GET_DATAPROFILE";
            case RIL_REQUEST_CDMA_SET_DATAPROFILE: return "RIL_REQUEST_CDMA_SET_DATAPROFILE";
            case RIL_REQUEST_CDMA_GET_SYSTEMPROPERTIES: return "RIL_REQUEST_CDMA_GET_SYSTEMPROPERTIES";
            case RIL_REQUEST_CDMA_SET_SYSTEMPROPERTIES: return "RIL_REQUEST_CDMA_SET_SYSTEMPROPERTIES";
            case RIL_REQUEST_OMADM_SETUP_SESSION: return "RIL_REQUEST_OMADM_SETUP_SESSION";
            ...
            case RIL_REQUEST_MODEM_HANGUP: return "RIL_REQUEST_MODEM_HANGUP";
            case RIL_REQUEST_PS_ATTACH: return "RIL_REQUEST_PS_ATTACH";
            case RIL_REQUEST_PS_DETACH: return "RIL_REQUEST_PS_DETACH";
            case RIL_REQUEST_SIM_AUTH: return "RIL_REQUEST_SIM_AUTH";
            case RIL_REQUEST_SUSPEND_DATA_CHANNELS: return "RIL_REQUEST_SUSPEND_DATA_CHANNELS";
            case RIL_REQUEST_RESUME_DATA_CHANNELS: return "RIL_REQUEST_RESUME_DATA_CHANNELS";
            case RIL_REQUEST_SETUP_DEDICATED_BEARER: return "RIL_REQUEST_SETUP_DEDICATED_BEARER";
            case RIL_REQUEST_GET_MPSR: return "RIL_REQUEST_GET_MPSR";
            case RIL_REQUEST_SET_MPSR: return "RIL_REQUEST_SET_MPSR";
...
*/
        switch(request) {
            ...
            case RIL_UNSOL_VOICE_PRIVACY_CHANGED: return "RIL_UNSOL_VOICE_PRIVACY_CHANGED";
            ...
            case RIL_UNSOL_RESPONSE_NEW_CB_MSG: return "RIL_UNSOL_RESPONSE_NEW_CB_MSG";
            case RIL_UNSOL_RESEND_INCALL_MUTE: return "UNSOL_RESEND_INCALL_MUTE";
            case RIL_UNSOL_RESPONSE_NO_NETWORK_RESPONSE: return "RIL_UNSOL_RESPONSE_NO_NETWORK_RESPONSE";
            case RIL_UNSOL_SIM_SMS_STORAGE_AVAILALE: return "RIL_UNSOL_SIM_SMS_STORAGE_AVAILALE";
            case RIL_UNSOL_HSDPA_STATE_CHANGED: return "RIL_UNSOL_HSDPA_STATE_CHANGED";
            case RIL_UNSOL_SYSTEM_REBOOT: return "UNSOL_SYSTEM_REBOOT";
            case RIL_UNSOL_OMADM_SEND_DATA: return "RIL_UNSOL_OMADM_SEND_DATA";
            case RIL_UNSOL_DUN: return "RIL_UNSOL_DUN";
            case RIL_UNSOL_UTS_GETSMSCOUNT: return "RIL_UNSOL_UTS_GETSMSCOUNT";
            case RIL_UNSOL_UTS_GETSMSMSG: return "RIL_UNSOL_UTS_GETSMSMSG";
            case RIL_UNSOL_UTS_GET_UNREAD_SMS_STATUS: return "RIL_UNSOL_UTS_GET_UNREAD_SMS_STATUS";
            case RIL_UNSOL_IPV6_ADDR: return "RIL_UNSOL_IPV6_ADDR";
            case RIL_UNSOL_NWK_INIT_DISC_REQUEST: return "RIL_UNSOL_NWK_INIT_DISC_REQUEST";
            case RIL_UNSOL_GPS_NOTI: return "UNSOL_GPS_NOTI";
            case RIL_UNSOL_RESPONSE_HANDOVER: return "RIL_UNSOL_RESPONSE_HANDOVER";
            case RIL_UNSOL_SETUP_DEDICATED_BEARER: return "RIL_UNSOL_SETUP_DEDICATED_BEARER";
            case RIL_UNSOL_RESPONSE_LOOPBACK_CALL: return "RIL_UNSOL_RESPONSE_LOOPBACK_CALL";
            case RIL_UNSOL_RADIO_REFRESH: return "RIL_UNSOL_RADIO_REFRESH";
            case RIL_UNSOL_ISIM_REFRESH: return "RIL_UNSOL_ISIM_REFRESH";
    ...
    public void resumeDataChannels(int i, Message response) {
        RILRequest rr = RILRequest.obtain(RIL_REQUEST_RESUME_DATA_CHANNELS, response);
        rr.mp.writeInt(1);
        rr.mp.writeInt(i);
        if (RILJ_LOGD) riljLog(rr.serialString() + "> " + requestToString(rr.mRequest));
        send(rr);
