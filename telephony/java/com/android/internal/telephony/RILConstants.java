...
public interface RILConstants {
    ...
    int NETWORK_MODE_GLOBAL         = 7; /* GSM/WCDMA, CDMA, and EvDo (auto mode, according to PRL)
                                            AVAILABLE Application Settings menu*/
    int PREFERRED_NETWORK_MODE      = NETWORK_MODE_CDMA; //NETWORK_MODE_WCDMA_PREF; <-Samsung RIL
...
*/
    ...
    /* additions taken from Samsung Charge framework.jar */
    String CDMA_SOCKET_NAME_RIL = "cdma_rild";
    int EHRPD_DATA = 2;
    int EVDO_DATA = 3;
    int LTE_DATA = 1;
    String LTE_SOCKET_NAME_RIL = "lte_rild";
    int NETWORK_MODE_CDMA_AND_LTE_EVDO = 8;
    int NETWORK_MODE_CDMA_ONLY = 9;
    int NETWORK_MODE_EHRPD_CAPABLE = 10;
    int NETWORK_MODE_EVDO_NO_EHRPD_CAPABILITY = 11;
    int NETWORK_MODE_GLOBAL_LTE = 10;
    int NETWORK_MODE_GSM_WCDMA_LTE = 9;
    int NETWORK_MODE_LTE_ONLY = 8;
    int RIL_OEM_REQUEST_BASE = 10000;
    int RIL_OEM_UNSOL_RESPONSE_BASE = 11000;
    int RIL_REQUEST_ACCESS_PHONEBOOK_ENTRY = 10009;
    int RIL_REQUEST_CALL_DEFLECTION = 10011;
    int RIL_REQUEST_CDMA_GET_DATAPROFILE = 10025;
    int RIL_REQUEST_CDMA_GET_SYSTEMPROPERTIES = 10027;
    int RIL_REQUEST_CDMA_SET_DATAPROFILE = 10026;
    int RIL_REQUEST_CDMA_SET_SYSTEMPROPERTIES = 10028;
    int RIL_REQUEST_CRFM_LINE_SMS_COUNT_MSG = 10003;
    int RIL_REQUEST_CRFM_LINE_SMS_READ_MSG = 10004;
    int RIL_REQUEST_DIAL_EMERGENCY_CALL = 10016;
    int RIL_REQUEST_DIAL_VIDEO_CALL = 10010;
    int RIL_REQUEST_GET_CELL_BROADCAST_CONFIG = 10002;
    int RIL_REQUEST_GET_LINE_ID = 10019;
    int RIL_REQUEST_GET_MPSR = 10041;
    int RIL_REQUEST_GET_PHONEBOOK_ENTRY = 10008;
    int RIL_REQUEST_GET_PHONEBOOK_STORAGE_INFO = 10007;
    int RIL_REQUEST_GET_STOREAD_MSG_COUNT = 10017;
    int RIL_REQUEST_LOCK_INFO = 10014;
    int RIL_REQUEST_MODEM_HANGUP = 10032;
    int RIL_REQUEST_OMADM_CLIENT_START_SESSION = 10023;
    int RIL_REQUEST_OMADM_SEND_DATA = 10024;
    int RIL_REQUEST_OMADM_SERVER_START_SESSION = 10022;
    int RIL_REQUEST_OMADM_SETUP_SESSION = 10021;
    int RIL_REQUEST_PS_ATTACH = 10033;
    int RIL_REQUEST_PS_DETACH = 10034;
    int RIL_REQUEST_PS_DETACH_CONFIRM = 10036;
    int RIL_REQUEST_PS_DISCONNECT_CONFIRM = 10037;
    int RIL_REQUEST_READ_SMS_FROM_SIM = 10012;
    int RIL_REQUEST_RESUME_DATA_CHANNELS = 10038;
    int RIL_REQUEST_SEND_ENCODED_USSD = 10005;
    int RIL_REQUEST_SEND_MOBILE_TRACKER_SMS = 10015;
    int RIL_REQUEST_SEND_SMS_COUNT = 10029;
    int RIL_REQUEST_SEND_SMS_MSG = 10030;
    int RIL_REQUEST_SEND_SMS_MSG_READ_STATUS = 10031;
    int RIL_REQUEST_SETUP_DEDICATED_BEARER = 10040;
    int RIL_REQUEST_SET_CELL_BROADCAST_CONFIG = 10001;
    int RIL_REQUEST_SET_LINE_ID = 10020;
    int RIL_REQUEST_SET_MPSR = 10042;
    int RIL_REQUEST_SET_PDA_MEMORY_STATUS = 10006;
    int RIL_REQUEST_SIM_AUTH = 10035;
    int RIL_REQUEST_STK_SIM_INIT_EVENT = 10018;
    int RIL_REQUEST_SUSPEND_DATA_CHANNELS = 10039;
    int RIL_REQUEST_USIM_PB_CAPA = 10013;
    int RIL_UNSOL_AM = 11010;
    int RIL_UNSOL_DATA_SUSPEND_RESUME = 11012;
    int RIL_UNSOL_DEVICE_READY_NOTI = 11008;
    int RIL_UNSOL_DUN = 11018;
    int RIL_UNSOL_DUN_CALL_STATUS = 11004;
    int RIL_UNSOL_DUN_PIN_CONTROL_SIGNAL = 11011;
    int RIL_UNSOL_GPS_NOTI = 11009;
    int RIL_UNSOL_HSDPA_STATE_CHANGED = 11016;
    int RIL_UNSOL_IPV6_ADDR = 11020;
    int RIL_UNSOL_ISIM_REFRESH = 11026;
    int RIL_UNSOL_NWK_INIT_DISC_REQUEST = 11021;
    int RIL_UNSOL_O2_HOME_ZONE_INFO = 11007;
    int RIL_UNSOL_OMADM_SEND_DATA = 11017;
    int RIL_UNSOL_RADIO_REFRESH = 11025;
    int RIL_UNSOL_RELEASE_COMPLETE_MESSAGE = 11001;
    int RIL_UNSOL_RESPONSE_HANDOVER = 11023;
    int RIL_UNSOL_RESPONSE_LINE_SMS_COUNT = 11005;
    int RIL_UNSOL_RESPONSE_LINE_SMS_READ = 11006;
    int RIL_UNSOL_RESPONSE_LOOPBACK_CALL = 11024;
    int RIL_UNSOL_RESPONSE_NEW_CB_MSG = 11000;
    int RIL_UNSOL_RESPONSE_NO_NETWORK_RESPONSE = 11014;
    int RIL_UNSOL_SAP = 11013;
    int RIL_UNSOL_SETUP_DEDICATED_BEARER = 11022;
    int RIL_UNSOL_SIM_SMS_STORAGE_AVAILALE = 11015;
    int RIL_UNSOL_STK_CALL_CONTROL_RESULT = 11003;
    int RIL_UNSOL_STK_SEND_SMS_RESULT = 11002;
    int RIL_UNSOL_SYSTEM_REBOOT = 11019;
    int RIL_UNSOL_UTS_GETSMSCOUNT = 11028;
    int RIL_UNSOL_UTS_GETSMSMSG = 11029;
    int RIL_UNSOL_UTS_GET_UNREAD_SMS_STATUS = 11030;
    int RIL_UNSOL_VOICE_PRIVACY_CHANGED = 11027;
    int RTT_DATA = 4;
    int SETUP_DATA_TECH_EHRPD = 3;
    int SMS_DSAC_FAILURE = 16;
}
